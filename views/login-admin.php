...
if (isset($_POST['login'])) {
    ...
    $result=mysqli_query($koneksi, "SELECT * FROM administrator WHERE username = '$username'");

    if(mysqli_num_rows($result)===1){   
        $row=mysqli_fetch_assoc($result);
        if(password_verify($password, $row["password"])){
            $_SESSION["login"]=true;
            header("Location: ../interface/admin/arsip.php");
        }else{
    ...
    <div class="background">
        <div class="card-container">
            <div class="card-login">
                ...
                <h1 style="color:white; margin-bottom:1%;">Login Admin</h1>
